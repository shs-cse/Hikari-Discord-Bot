...
from member_verification.response import VerificationFailure, verify_student
from member_verification.student_checks import (check_retyped_user_input, 
...
async def check_student(member: hikari.Member, input_text: str, reinput_text: str=None):
    try:
        # possible cases of VerificationFailure:
        # 0. retyped input does not match
        if reinput_text:
            check_retyped_user_input(input_text)
        ...
        #       a. takem by another -> contact admin. 
